...
const offWelcomeCommand = {
  name: ".off",
  category: "grupos",
  description: "Desactiva configuraciones (ej: `.off welcome`) en el grupo.",
  ...
  async execute({ sock, msg, args = [] }) {
    ...
    if (!what) return sock.sendMessage(from, { text: "Indica qué desactivar. Ejemplo: `.off welcome`" }, { quoted: msg });
...
export default offWelcomeCommand;
